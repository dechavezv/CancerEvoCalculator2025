               seqfile = ../results/MYC.aligned.fasta   * sequence data file name
              treefile = ../results/MYC.BL.tree        * tree structure file name
               outfile = out.modelA         * main result file name
